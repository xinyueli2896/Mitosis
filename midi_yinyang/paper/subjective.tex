...
%   the figure (reported form since the ANOVA, 2026-09-23):
%     figures/subjective_dots.pdf from figures/plot_subjective_dots.py
%     (mean +/- Cousineau-Morey within-subject 95% CI, Holm post-hoc
%     markers). The spider chart figures/subjective_spider.pdf and the
%     table paper/tables/listening_mos.tex are kept but not \input.
