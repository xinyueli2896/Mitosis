...
if __name__ == '__main__':
    # Patch the jointattn inference module to use OUR load_model AND OUR
    # generation loop. Then reuse its main() / CLI dispatch.
    import cp_transformer_m2c_jointattn_inference as _ja_inf
    _ja_inf.load_model = load_model
    _ja_inf.general_inference = general_inference_duet_block
    _ja_inf.main()
