...
def build():
    ...
    # legend
    lx0, ly0 = 0.4, 0.3
    S.rect(lx0, ly0, 2.9, 1.95, fill='FFFFFF', line=INK, lw=0.8)
    ...
    S.text(lx0 + 0.12, ly0 + 0.34 + 6 * 0.23 - 0.02, 2.7, 0.2, plain('new: gates, routers, harmonizer embeddings'), size=6.5, color=INK_2, align='l')
