...
def build():
    ...
    S.text(cQX - 0.75, yC + tk + 0.02, 1.5, 0.18, plain('harmonizer, predicts frame 4'), size=7, color=INK_2)
    S.text(cQY - 0.75, yC + tk + 0.02, 1.5, 0.18, plain('harmonizer, predicts frame 4'), size=7, color=INK_2)
