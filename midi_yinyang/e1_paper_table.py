...
SYSTEM_ORDER = ['A11aT', 'A11K4', 'A3fctcaT', 'A3fcaT', 'A3fcaTar', 'A3fcK4', 'A3ctcaT', 'A3ctca', 'A3ctc', 'A3ctc2', 'A3', 'A3K0', 'A3ctcc', 'A3f', 'A3c', 'A3fc', 'A10', 'A1', 'A1cp8', 'S1', 'S-scratch', 'P-mc', 'P-cm', 'WS']
SYSTEM_NAME = {
    'A3': r'Duet, refine $K{=}4$',
    'A3f': r'Duet, slot sees $t{-}1$',
    'A3fctcaT': r'Duet, slot sees $t{-}1$, alternating commit',
    'A3c': r'Duet, conditional slots',
    'A3fc': r'Duet, cond. slots + $t{-}1$',
    'A3fcaT': r'Duet (cond.-slot trained, cp8), alternating commit',
    'A11aT': r'Duet + agreement head, alternating commit',
    'A11K4': r'Duet + agreement head, refine $K{=}4$',
    'A3fcaTar': r'Duet (cond.-slot trained, cp8, AR-selected), alternating commit',
    'A3fcK4': r'Duet (cond.-slot trained, cp8), refine $K{=}4$',
